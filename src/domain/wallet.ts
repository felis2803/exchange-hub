...
import type { AccountId, BaseEntity, DomainUpdate, TimestampISO } from '../core/types';
...
export class Wallet extends EventEmitter implements BaseEntity<WalletSnapshot> {
    ...
    #buildSnapshot(balances: Map<string, WalletBalanceSnapshot>, updatedAt?: TimestampISO): WalletSnapshot {
