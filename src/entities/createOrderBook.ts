...
export function createOrderBook<ExName extends ExchangeName>(eh: ExchangeHub<ExName>, Entity: EntityClass<ExName>) {
...
export type OrderBookClass<ExName extends ExchangeName> = ReturnType<typeof createOrderBook<ExName>>;
